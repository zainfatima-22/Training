<nav class="bg-gray-800">
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <?php if ($_SESSION['user'] ?? false) : ?>
                ...
                <?php else: ?>    
                  <a href="/register" class="<?php url('/register')?> text-gray-300 rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Register</a>
                  <a href="/login" class="<?php url('/login')?> text-gray-300 rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Login</a>
            ...
            <?php if ($_SESSION['user'] ?? false) : ?>
              <div class="ml-3">
                <form method="POST" action="/session">
                  ...
                  <button class="text-gray-300 rounded-md px-3 py-2 text-sm font-medium bg-indigo-600 hover:bg-white/5 hover:text-white">Logout</button>
                </form>  
                </div>  
            <?php endif; ?>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="projects.php" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Projects</a>
        ...
        <a href="#" class="block rotext-gray-300 unded-md px-3 py-2 text-base font-medium hover:bg-white/5 hover:text-white">Contact Us</a>
      </div>
